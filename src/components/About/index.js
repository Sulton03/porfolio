      ...
      <div className="flex flex-row  gap-6 ml-8">
        <div className="flex-col mt-14 flex flex-auto w-64 gap-6">
          <h3
            ...
            data-aos={"fade-left"}
          >
            I'm <span className="text-yellow-600"></span> a Frontend Developer
          </h3>
          <p
          ...
          >
            ...
            I worked on reactJs, JavaScript, GitHub, HTML\CSS, Bootstrap, and others. I am
