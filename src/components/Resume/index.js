      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-7 mt-7">
        <ol class="relative border-l  border-gray-700 ml-9 mb-6">
          <li class="mb-10" data-aos="zoom-in">
            ...
            <a
              href="https://drive.google.com/file/d/1__NeT89C3sLwCOserfoKq8R1RgdfquCd/view?usp=sharing"
              target="_blank"
              rel="noreferrer"
          ...
          <li class="mb-10" data-aos="zoom-out" data-aos-delay="700">
            ...
            front-end developer course from IT-Park Tashkent 
            </h3>
            <time class="block mb-2 text-sm font-normal leading-none text-gray-500">
              Completed on November 17, 2023
            </time>
            <p class="text-base font-normal text-gray-400">
              Learns how to style your site quickly with Bootstrap. I also learn
              how to add logic to your CSS styles.
              Later, I also built  other applications to
              learn how to create powerful Single Page Applications with
              React.
            </p>
            <a
              target="_blank"
              rel="noreferrer"
              href="https://drive.google.com/file/d/1vtI0dRQ6Ea-wPxwzw0tsHfyE6FcgQM50/view?usp=sharing"
        ...
        <div className="flex flex-col text-center" data-aos="slide-up">
          ...
          <div className="ml-16 flex flex-col gap-8 mt-6">
            ...
            <BarGraph name={"GitHub"} percent={60} />
          </div>

          <a
            href={require("../../assets/files/Sulton_resume.pdf")}
            download={"Sulton's Resume"}
